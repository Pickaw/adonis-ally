 ...
 * @constructor
 */
class TwitterWrite extends OAuthScheme {
  constructor (Config) {
    const config = Config.get('services.ally.twitterWrite')

    utils.validateDriverConfig('twitterWrite', config)
    utils.debug('twitterWrite', config)
